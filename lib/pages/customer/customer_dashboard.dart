...
import 'package:yang_chow/pages/customer/customer_menu_page.dart';
...
class _CustomerDashboardPageState extends State<CustomerDashboardPage> {
          ...
          child: Column(
            ...
            children: [
              ...
              ...List.generate(7, (index) {
                ...
                final labels = ['Home', 'Reservations', 'Chat', 'Menu', 'Quotations', 'Activity', 'Account'];
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    ...
                    child: _buildMobileNavItem(3, Icons.restaurant_menu_rounded, 'Menu'),
                  ...
                  Expanded(
                    ...
                    child: _buildMobileNavItem(4, Icons.monetization_on_rounded, 'Quotations'),

                  ),

                  Expanded(

                    child: _buildMobileNavItem(5, Icons.assignment_rounded, 'Activity'),
                  ...
                  Expanded(
                    ...
                    child: _buildMobileNavItem(6, Icons.person_rounded, 'Account'),
                                  ...
                                  children: [
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            ..._selectedMenuItems.entries.map((entry) => Padding(
                                    ...
                                    SizedBox(
                                      ...
                                      child: ElevatedButton.icon(
                                        ...
                                        label: Text(_selectedMenuItems.isEmpty ? 'Select Menu Items' : 'Change Selection'),
  ...
  Future<void> _createReservationWithoutPayment(
    ...
    try {
      ...
      if (_selectedMenuItems.isNotEmpty) {
        ...
        final totalMenuPrice = _menuReservationService.calculateMenuTotalPrice(_selectedMenuItems);

        final depositAmount = _menuReservationService.calculateMenuDepositAmount(totalMenuPrice);
      ...
      if (_selectedMenuItems.isNotEmpty) {
        ...
        _showSuccessDialog('Reservation created successfully! You will receive a price quotation shortly.');
  ...
  void _submitReservation() async {
    ...
    if (_selectedMenuItems.isNotEmpty) {
      ...
      final validation = _menuReservationService.validateMenuSelection(_selectedMenuItems);
      ...
      if (!_menuReservationService.isMenuSelectionReasonable(_selectedMenuItems, guestCount)) {

        _showSnackBar('Menu selection may not be suitable for $guestCount guests', Colors.orange);
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Icon(Icons.restaurant_menu, color: AppTheme.primaryColor, size: 16),
                      ...
                      ..._buildMenuItemsList(reservation['selected_menu_items']),
