    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          // Show approval/rejection timestamp for completed requests
              ...
              child: Row(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '${status} ${_formatDateTime(request['updated_at']?.toString() ?? createdAt)}',
              ...
              builder: (context, snapshot) {
                ...
                return Column(
                  ...
                  children: [
                    ...
                    // Request Counter (only show for Pending filter)
                          ...
                          return Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Icon(Icons.filter_list_off, size: 60, color: AppTheme.darkGrey),

                                const SizedBox(height: 16),

                                Text(

                                  'No ${_requestFilterLabels[_requestFilter]} requests',
