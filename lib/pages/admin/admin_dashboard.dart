  ...
  void _processData(
    ...
    _dailyRevenue = regularRevenue + advanceRevenue + (() {
      ...
      final todayEventReservations = allReservations.where((r) {
        ...
        if (isToday || isPaid) {
          ...
          print('DEBUG: Event - Date: $eventDate, Today: $todayStr, Paid: $paymentStatus, Amount: ${r['total_price']}');
      ...
      print('DEBUG: Today event reservations count: ${todayEventReservations.length}');
    ...
    final paidEventReservations = allReservations.where((r) {
      ...
      if (isPaid) {
        ...
        print('DEBUG: Paid Event - Status: $status, Payment: $paymentStatus, Amount: $totalPrice');
          ...
          if (_popularEventTypes.isEmpty)
            ...
            const Center(
              ...
              child: Padding(
                ...
                child: Text('No completed events yet', style: TextStyle(color: AppTheme.mediumGrey, fontSize: 12)),
