              ...
              if (isDesktop)
                ...
                Row(
                  ...
                  children: [
                    ...
                    _navLink('Map', () => _scrollToSection(_mapKey), Colors.white),
                        ...
                        if (isDesktop)
                          ...
                          Wrap(
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: _buildContactItem(Icons.location_on_rounded, 'Our Location', 'CLA Town Center Mall\nPagsanjan, Laguna, Philippines 4008'),
                              ...
                              SizedBox(
                                ...
                                child: _buildContactItem(Icons.schedule_rounded, 'Opening Hours', 'Monday – Sunday: 10:00 AM – 08:00 PM'),
                              ...
                              SizedBox(
                                ...
                                child: _buildContactItem(Icons.phone_rounded, 'Call Us', 'TEL# 501-9179\nCP# +63975-041-9671'),
                              ...
                              SizedBox(
                                ...
                                child: _buildContactItem(Icons.email_rounded, 'Email', 'reservations@yangchow.ph\nsupport@yangchow.ph'),
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              _buildContactItem(Icons.location_on_rounded, 'Our Location', 'CLA Town Center Mall\nPagsanjan, Laguna, Philippines 4008'),

                              const SizedBox(height: 20),

                              _buildContactItem(Icons.schedule_rounded, 'Opening Hours', 'Monday – Sunday: 10:00 AM – 08:00 PM'),

                              const SizedBox(height: 20),

                              _buildContactItem(Icons.phone_rounded, 'Call Us', 'TEL# 501-9179\nCP# +63975-041-9671'),

                              const SizedBox(height: 20),

                              _buildContactItem(Icons.email_rounded, 'Email', 'reservations@yangchow.ph\nsupport@yangchow.ph'),
  ...
  Widget _buildFooterCol2() {
    ...
    return Column(
      ...
      children: [
        ...
        const _FooterLink(text: 'Profile'),
        ...
        const _FooterLink(text: 'Careers'),

        const SizedBox(height: 10),

        _FooterLink(text: 'Testimonials', onTap: () => _scrollToSection(_reviewsKey)),

        const SizedBox(height: 10),

        _FooterLink(text: 'Location', onTap: () => _scrollToSection(_mapKey)),

        const SizedBox(height: 10),

        const _FooterLink(text: 'Privacy Policy'),
